...
namespace ose {
    ...
    OseSwapChain::OseSwapChain(OseDevice& deviceRef, VkExtent2D extent)
        : device{ deviceRef }, windowExtent{ extent } {
        init();
    }

    OseSwapChain::OseSwapChain(
        OseDevice& deviceRef, VkExtent2D extent, std::shared_ptr<OseSwapChain> previous)
        : device{ deviceRef }, windowExtent{ extent }, oldSwapChain{ previous } {
        init();
        oldSwapChain = nullptr;
    }

    void OseSwapChain::init() {
        createSwapChain();
        createImageViews();
        createRenderPass();
    ...
    VkResult OseSwapChain::acquireNextImage(uint32_t* imageIndex) {
    ...
    VkResult OseSwapChain::submitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex) {
    ...
    void OseSwapChain::createSwapChain() {
    ...
    void OseSwapChain::createImageViews() {
    ...
    void OseSwapChain::createRenderPass() {
    ...
    void OseSwapChain::createFramebuffers() {
    ...
    void OseSwapChain::createDepthResources() {
    ...
    void OseSwapChain::createSyncObjects() {
    ...
    VkSurfaceFormatKHR OseSwapChain::chooseSwapSurfaceFormat(
    ...
    VkPresentModeKHR OseSwapChain::chooseSwapPresentMode(
    ...
    VkExtent2D OseSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
    ...
    VkFormat OseSwapChain::findDepthFormat() {
